...
class ControllerScript extends \Hola\Core\Command
{
    ...
    public function handle()
    {
        ...
        $concurrentDirectory = __DIR__ROOT . "/App/Http/Controllers/$name_controller.php";
        if (!file_exists(__DIR__ROOT . "/App/Http/Controllers/$name_controller.php")) {
            file_put_contents(__DIR__ROOT . "/App/Http/Controllers/$name_controller.php", "<?php
